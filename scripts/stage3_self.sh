...
P=0; F=0
for src in main.c dump_ast.c base/*.c tokenizer/*.c pp/*.c parser/lr/*.c parser/ll/*.c parser/parse.c ast-opt/*.c ir/*.c ir/gen/*.c ir/dump/*.c ir-opt/*.c cuda/*.c vulkan/*.c llvm-codegen/*.c; do
    [ -f "$src" ] || continue
    b="$(echo "$src" | tr '/' '_')"
