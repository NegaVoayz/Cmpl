...
for o in "$MODDIR"/*.o; do
  case "$(basename "$o")" in main.o|main.c.o|main_driver.o|main_driver.c.o|main_batch.o|main_batch.c.o|dump_ast.o|dump_ast.c.o|dump_ast_decl.o|dump_ast_decl.c.o) ;; *) MODOBJS+=("$o");; esac
done
