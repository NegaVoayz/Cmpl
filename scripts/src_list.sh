...
CMPL_SOURCES=(
  ...
  parser/lr/lr1_generic.c parser/lr/lr1_va_arg.c
  ...
  parser/ll/ll_stmt_ctrl_jump.c parser/ll/ll_sa.c parser/ll/ll_type.c parser/ll/ll_declarator_rot.c parser/ll/decl/ll_declarator.c parser/ll/decl/ll_declarator_params.c parser/ll/decl/ll_declarator_suffix.c
  ...
  ir/builder/ir_builder.c ir/builder/ir_builder_block.c ir/builder/ir_builder_const.c ir/builder/ir_builder_cast.c ir/builder/ir_builder_ops.c ir/builder/ir_builder_mem.c ir/type/ir_type.c ir/type/ir_type_ast.c ir/type/ir_type_struct.c ir/type/ir_type_layout.c ir/type/ir_type_bf.c ir/type/ir_type_bfq.c ir/ir_gen_cuda.c
  ir/gen/ir_gen.c ir/gen/ir_gen_module.c ir/gen/ir_gen_module_emit.c ir/gen/ir_gen_func.c ir/gen/resolve/ir_gen_resolve.c ir/gen/resolve/ir_gen_resolve_ast.c ir/gen/resolve/ir_gen_resolve_struct.c ir/gen/sa/ice_addr.c ir/gen/sa/ice_eval.c ir/gen/sa/ice_binary.c ir/gen/sa/ice_cast_sizeof.c ir/gen/sa/ice_type.c ir/gen/sa/sa_walk.c ir/gen/init/ir_gen_const.c ir/gen/expr/ir_gen_expr.c ir/gen/expr/ir_gen_cast.c ir/gen/expr/lval/ir_gen_member.c ir/gen/expr/lval/ir_gen_bf.c ir/gen/init/ir_gen_init.c ir/gen/ir_gen_stmt.c ir/gen/ir_gen_stmt_ctrl.c ir/gen/ir_gen_stmt_jump.c ir/gen/expr/ir_gen_logical.c ir/gen/expr/ir_gen_binary.c ir/gen/expr/ir_gen_unary.c ir/gen/expr/ir_gen_call.c ir/gen/expr/ir_gen_ternary.c ir/gen/expr/lval/ir_gen_lval.c ir/gen/expr/lval/ir_gen_index.c ir/gen/expr/ir_gen_generic.c ir/gen/expr/va/ir_gen_va_arg.c ir/gen/expr/va/ir_gen_va_intrinsic.c ir/gen/init/desig/ir_gen_init_desig.c ir/gen/init/desig/ir_gen_const_desig.c ir/gen/init/desig/ir_gen_const_cont.c ir/gen/init/desig/ir_gen_const_list.c ir/gen/init/desig/ir_gen_const_elem.c ir/gen/init/ir_gen_const_bytes.c ir/gen/init/ir_gen_const_bf.c ir/gen/init/ir_gen_const_generic.c ir/gen/init/ir_gen_const_ice.c
