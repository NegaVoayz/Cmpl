...
CMPL_SOURCES=(
  main.c main_driver.c main_batch.c dump_ast.c dump_ast_decl.c
  ...
  pp/inc/pp_include_paths.c pp/inc/pp_define.c pp/inc/pp_expand_ops.c pp/inc/pp_buf.c pp/inc/pp_cache.c pp/inc/pp_cache_rec.c
