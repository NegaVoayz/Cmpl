...
/* begin a statement: capture+skip the keyword, allocate the node from it */
AST_Node* ll_stmt_begin(LR1_Parser* p, AST_Type kind);

/* parse a C11 _Static_assert(ice, "msg"); declaration (ll_sa.c) */
