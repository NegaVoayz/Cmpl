...
IR_Value*   ir_build_uitofp(IR_Builder* b, IR_Value* val, IR_Type* to_ty);
IR_Value*   ir_build_fptosi(IR_Builder* b, IR_Value* val, IR_Type* to_ty);
IR_Value*   ir_build_fptoui(IR_Builder* b, IR_Value* val, IR_Type* to_ty);
